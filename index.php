			...
			<div class="col-md-6">
				<div id="accordion">
					<div class="card">
						...
						<h5 class="mb-0">
							<button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Como é feito o pagamento?</button>
						</h5>
						</div>

						<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								Uma das maiores dúvidas é essa. O pagamento é feito após a finalização e aprovação do serviço!<br />
...
<section class="section-padding-default" id="contact">
	<div class="container">
